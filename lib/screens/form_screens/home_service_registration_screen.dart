...
class HomeServiceRegistrationScreen extends StatefulWidget {
  const HomeServiceRegistrationScreen({Key? key}) : super(key: key);

  @override
  State<HomeServiceRegistrationScreen> createState() =>
      _HomeServiceRegistrationScreenState();
}

class _HomeServiceRegistrationScreenState
    extends State<HomeServiceRegistrationScreen> {
  int nodeIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text('Shop Act Number', style: kFormFieldHintTextStyle),
        const SizedBox(
          height: 12,
        ),
        TextField(
          style: kFormFieldTextStyle,
          decoration:
          kTextFieldDecoration.copyWith(hintText: '000000'),
        ),
        const SizedBox(
          height: 80,
        ),
